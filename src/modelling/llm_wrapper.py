...
class ChatGPTWrapper():
    def __init__(self):
        ...
        self.prompt_templates = json.load(open(str(Path(__file__).parent / "prompt_store.json"), "rb"))
...
if __name__ == "__main__":
    x = ChatGPTWrapper()
    testcase = ['man stabbed outside shops ', 'niramax murder case 2', 'article title 3']
